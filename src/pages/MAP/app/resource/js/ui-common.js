    ...
    var Coverflow = {
        setTranslate: function setTranslate() {
            ...
            for (var i = 0, length = slides.length; i < length; i += 1) {
                ...
                var translateY = isHorizontal ? offsetMultiplier - (Math.abs(offsetMultiplier) * 8) : stretch * offsetMultiplier;
...
$(document).ready(function () {
    ...
    //Main Popular Game, Recommend Game - Swiper Option
    var slideOpt = {
        slidesPerView: 'auto',
        spaceBetween: 10
    }
...
var slider = function(){
    ...
    if ($(".main-top-slide-wrap").length > 0) {
        new Swiper('.main-top-slide-wrap .swiper-container', {
            ...
            pagination: {
                el: '.main-top-slide-wrap .swiper-pagination',
            }
        });
    }
}
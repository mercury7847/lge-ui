var res = {
	...
	"Front" : {
		...
		"Page" : {
			...
			"스토리(STR)" : {
				"매거진" : {
					"비하인드스토리" : ["/html/STR/OBS5006.html","","진행중"]
				},	
				"활용가이드" : {
					"체험리뷰" : ["/html/STR/OBS5008.html","","진행중"],
					"제품관리팁" : ["/html/STR/OBS5010.html","","진행중"]
				},
			},
			"케어솔루션(SLC)" : {
				"케어솔루션 제품안내" : {
			...
			"마이페이지(MYC)" : {
				...
				"고객지원 관리" : {
					...
					"나의 글 보기 상세페이지(레이어팝업)" : ["/html/MYC/ACCF7076.html","","검수요청"],
					"문의/예약 결과 조회 리스트" : ["/html/MYC/ACCF7020.html","","검수요청"],
					"문의/예약 결과 조회 상세페이지(레이어팝업)" : ["/html/MYC/ACCF7077.html","","검수요청"]
				},
				"활동 관리" : {

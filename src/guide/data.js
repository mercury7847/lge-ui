var res = {
	...
	"Front" : {
		...
		"Page" : {
			...
			"마이페이지(MYC)" : {
				"쇼핑 관리" : {
					"주문내역 조회(리스트)" : ["/html/MYC/ACCF7002.html","","진행중"],
					"주문내역 조회(상세)" : ["/html/MYC/ACCF7003.html","","진행중"],
					"배송내역 조회(리스트)" : ["/html/MYC/ACCF7004.html","","진행중"],
					"배송내역 조회(상세)" : ["/html/MYC/ACCF7005.html","","진행중"],
					"신청내역(리스트-케어솔루션)" : ["/html/MYC/ACCF7024.html","","진행중"],
					"신청내역(상세-케어솔루션)" : ["/html/MYC/ACCF7065.html","","진행중"],
					"취소/반품/교환 조회(리스트)" : ["/html/MYC/ACCF7006.html","","진행중"],
					"취소/반품/교환 조회(상세)" : ["/html/MYC/ACCF7007.html","","진행중"],
				},
				"케어솔루션" : {

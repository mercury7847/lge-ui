    ...
    var Accordion = ui('Accordion', /**@lends vcui.ui.Accordion# */{
        ...
        _buildARIA: function _buildARA() {
            ...
            self.$items.each(function () {
                ...
                $btn.attr({
                    //'id': 'accrod_toggle_' + id, //210831 BTOCSITE-4154 뷰저블 쿼리셀렉터 이슈 해결
                    //'aria-controls': 'accord_content_' + id, //210831 BTOCSITE-4154 뷰저블 쿼리셀렉터 이슈 해결
                    'aria-expanded': $btn.attr('aria-expanded') === 'true'
                }).parent().attr('role', 'heading');

                $content.attr({
                    //'id': 'accord_content_' + id, //210831 BTOCSITE-4154 뷰저블 쿼리셀렉터 이슈 해결
                    'role': 'region'
                    //'aria-labelledby': 'accord_toggle_' + id //210831 BTOCSITE-4154 뷰저블 쿼리셀렉터 이슈 해결
                });
            });
        },

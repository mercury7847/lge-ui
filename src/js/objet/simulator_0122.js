...
(function(objSimulator){
    ...
    var backgroundImageURL = '../content/images/simulator_img3/bg/', //배경 이미지 저장경로
        objectImageURL = '../content/images/simulator_img3/'; //오브제 이미지 저장경로
...
/*
    ...
    <div id="objet_object01" class="objet01_base base01 obj01" itemw="214" itemh="439" itemt="213" iteml="485" data-id="objType01_Fenix01" data-object-select-area="">
        <a href="#">
            <p><img src="../content/images/simulator_img3/rf_door01_01fn_botanic.png" alt="" /></p>
        </a>
    </div>
 */
                var outputHtml = '';
                ...
                /*
                    <li>
                        ...
                        <label for="refrigerator">
                            <span class="default" style="background-image:url(../content/images/simulator_img3/appliances/Thumb_01.png);">상냉장 냉장고</span>
                            <span class="focus" style="background-image:url(../content/images/simulator_img3/appliances/Thumb_01_selected.png);">상냉장 냉장고</span>
                        </label>
                    </li>
                */
                var outputHtml = '';

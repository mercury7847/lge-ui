(function() {
    ...
    modelSimulator = {
        ...
        priceCheck: function(idx, modelCate, modelName, defaultModel, defaultPrice, doorInfo) {
            ...
            priceHtml += '          <p class="desc" >소재/컬러 체험해보시고 패널만 따로 신청해 주세요. <a class="more btn-link" data-go-url data-open-mode="outlink" data-href="http://www.lge.co.kr/story/user-guide/objetcollection-change-panel-guide"><u>자세히 보기</u></a></p>';
            priceHtml += '      </div>';
            priceHtml += '      <dd>';

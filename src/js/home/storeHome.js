...
;(function(){
    ...
    function init(){
        ...
        vcui.require(['ui/toggleCarousel', 'ui/tab', 'ui/lazyLoaderSwitch', 'ui/carousel'], function () {
            ...
            var storeExhibitionProductUrl = '/lg5-common/data-ajax/home/storeExhibition.json';
            var storeRecommendProductUrl = '/lg5-common/data-ajax/home/storeRecommendProduct.json';
            var storeNewRecommendProductUrl = '/lg5-common/data-ajax/home/storeNewRecommendProduct.json';
                ...
                if(data && data.data){
                    ...
                    $.each(posArr, function(index, item){
                        ...
                        if(list[index]){                        
                            ...
                            var $track = $('.new-product-list').find('.ui_carousel_track');

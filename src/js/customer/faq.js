(function() {
    ...
    var faq = {
        ...
        setting: function() {
            ...
            self.$searchButton = self.$searchWrap.find('button.btn-search');
        ...
        bindEvents: function() {
            ...
            self.$searchWrap.find('div.input-wrap input').keydown(function(key) {
                if (key.keyCode == 13) {
                    key.preventDefault();
        ...
        searchNewData: function() {
            ...
            if (!!window.location.hash){                
                ...
                if ($selectedTab.length > 0){
                    searchCategory = $selectedTab.attr('href').replace("#", "");
                }
            }
            /* //BTOCSITE-2851 :: hash 값이 있을때 해당 카테고리 불러오기 */

                ...
                '<div class="detail-wrap">' +
                    ...
                    '<div class="result-detail">' +
                        ...
                        '</div>' +
                            ...
                            '{{#if (subCategoryId == "CT50000070")}}<span class="care-n">,</span><span class="redcare-option">1년 무상케어&nbsp&nbsp&nbsp</span>{{/if}}' + '{{/if}}' +
                            '</div>'+
                            /* BTOCSITE-3404 검색, PLP > 얼음정수기냉장고 1년무상케어 태그 추가 건*/
            ...
            requestSearchData:function(value, force, filterQueryData, filterSearch) {
                ...
                lgkorUI.requestAjaxData(ajaxUrl, postData, function(result) {
                    ...
                    */
                    ...
                    var subcount = self.checkSubCountData(data.customer);
                    if(subcount) {

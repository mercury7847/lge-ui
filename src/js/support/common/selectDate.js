vcui.define('support/common/SelectDate', ['jquery', 'vcui'], function ($, core) {
    "use strict";
    ...
    var SelectDate = core.ui('SelectDate', /** @lends vcui.ui.SelectDate# */{
        bindjQuery: 'SelectDate',
        defaults: {
        ...
        _render: function _render() {
            ...
            self.$el.find(self.$calendar).off('.vcSelectDate').on('click.vcSelectDate', '.arrow', function (e) {
            ...
            }).on('click.vcSelectDate', '.day:not(.disabled)', function (e) {
                // 날짜 클릭
                e.preventDefault();

$(function(){
	...
	function scrollEvent(){
		...
		if ( scrollE >= 300 ) {
			...
			$(".only_pc .ref-img img").attr("src",$(".only_pc .ref-img img").attr("src").replace(/img-oven-big\.png$/, 'img-oven.png'));
		} else { 
			$(".only_pc .ref-img").removeClass("scroll");
			$(".only_pc .ref-img img").attr("src",$(".only_pc .ref-img img").attr("src").replace(/img-oven\.png$/, 'img-oven-big.png'));
		}
		
		var fadeStart = 500, fadeUntil = 700, fadeOut = 1000, fadeEnd = 1200, fading = $(".ref-bg");

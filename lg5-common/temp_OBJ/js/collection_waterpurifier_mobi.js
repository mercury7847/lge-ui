$(function() {
    ...
    function scrollEventM() {
        ...
        if (scrollEM >= 1 && scrollEM < 30) {
            ...
            var tranlateM = 'scale(0.5) translateY(' + -scrollEM * 0.5 + 'px) translateX(0px)';
            $(".only_mobile .ref-img").css({
                transform: tranlateM,
            });
        ...
        if (scrollEM >= 30) {
            ...
            $(".only_mobile .ref-img img").attr("src", $(".only_mobile .ref-img img").attr("src").replace(/img-wp-big\.png$/, 'img-wp.png'));
        } else {
            $(".only_mobile .ref-img").removeClass("scroll");
            $(".only_mobile .ref-img img").attr("src", $(".only_mobile .ref-img img").attr("src").replace(/img-wp\.png$/, 'img-wp-big.png'));
        }

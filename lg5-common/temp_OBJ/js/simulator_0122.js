if (navigator.userAgent.match(/Mobile|iP(hone|od)|BlackBerry|IEMobile|Kindle|NetFront|Silk-Accelerated|(hpw|web)OS|Fennec|Minimo|Opera M(obi|ini)|Blazer|Dolfin|Dolphin|Skyfire|Zune/)) {
    document.location.href = "/lg-objet-collection/space-experience/mobile";
}
...
(function(objSimulator) {
    ...
    var backgroundImageURL = '/lg5-common/images/OBJ/simulator/mobile/simulator_img3/bg/', //배경 이미지 저장경로
        objectImageURL = '/lg5-common/images/OBJ/simulator/mobile/simulator_img3/'; //오브제 이미지 저장경로
    ...
    Simulator.prototype = {
        ...
        setBackground: function(styleName) {
            ...
            for (var i = 0; i < bgSliderImages.length; i++) {
                if (bgSliderImages[i].classList.contains('swiper-slide-active')) {
            ...
            if (stageSetting.objectArea !== null) {
                ...
                /*
                    ...
                    <div id="objet_object01" class="objet01_base base01 obj01" itemw="214" itemh="439" itemt="213" iteml="485" data-id="objType01_Fenix01" data-object-select-area="">
                        <a href="#">
                            <p><img src="./lg5-common/images/OBJ/simulator/mobile/simulator_img3/rf_door01_01fn_botanic.png" alt="" /></p>
                        </a>
                    </div>
                 */
                var outputHtml = '';
                ...
                for (var i = 0; i < configData.object.length; i++) {
                    ...
                    outputHtml += '<div class="objet" data-objet-id="' + configData.object[i].id + '">' +
                        '<input type="checkbox" class="objet-selected" name="objet-selected" value="' + configData.object[i].id + '" id="' + configData.object[i].id + '-select">';

                    for (var j = 0; j < configData.object[i].selections.length; j++) {
                        outputHtml += '<div id="objet_object-' + i + j + '" class="objet_base objet_resize"' +
                    ...
                    outputHtml += '<label class="objet_resize" for="' + configData.object[i].id + '-select"' +
        ...
        updateSideBar: function(ID, targetID) {
            ...
            */
            ...
            var scrollButtonClickEvent = function() {
                if (typeof Scrollbar == "function") {
                    _self.isSideScrollBarButtonClickEvent = true; // @pck 2020-10-27
                    var targetEl = document.querySelector('[data-simulator-sidebar-selector-area]');
            ...
            var surfaceScrollButton = document.querySelector('[data-surface-scroll-down]');
            if ((surfaceScrollButton !== null) && (!this.isSideScrollBarButtonClickEvent))
                surfaceScrollButton.addEventListener('click', scrollButtonClickEvent.bind(this));
            ...
            function objectActive(event) {
                ...
                if (!_this.classList.contains('active')) {
                    ...
                    if (_self.setObject(_this.dataset.objectId, _this.dataset.targetObject, _this.dataset.colorCode)) {
                        ...
                        //alert(_this.dataset.targetObject);
            ...
            var objSwiper = new Swiper('.obj-swiper-container', {
                ...
                on: {
                    init: function() {
                        ...
                        /*
                        var scrollIndicator = document.querySelectorAll('#scroll-indicator button');
                            if(scrollIndicator !== null && scrollIndicator.length > 0){
                                ...
                                for(var i = 0; i < scrollIndicator.length ; ++i ){
                                    scrollIndicator[i].addEventListener('click', scrollIndicatorClick.bind(this, scrollIndicator[i]));
                                }
                ...
                /*
                    <li>
                        ...
                        <label for="refrigerator">
                            <span class="default" style="background-image:url(./lg5-common/images/OBJ/simulator/mobile/simulator_img3/appliances/Thumb_01.png);">상냉장 냉장고</span>
                            <span class="focus" style="background-image:url(./lg5-common/images/OBJ/simulator/mobile/simulator_img3/appliances/Thumb_01_selected.png);">상냉장 냉장고</span>
                        </label>
                    </li>
                */
                var outputHtml = '';

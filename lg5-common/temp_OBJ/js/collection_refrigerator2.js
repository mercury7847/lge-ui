$(function(){
	...
	function scrollEvent(){
		...
		if ( scrollE >= 1 && scrollE < 300 ) {
			...
			var tranlate = 'scale(0.6) translateY('+ - scrollE * 0.70 + 'px)';
			$(".only_pc .ref-img").css({ 
				transform: tranlate,
			});   
		...
		if ( scrollE >= 300 ) {
			...
			$(".only_pc .ref-img img").attr("src",$(".only_pc .ref-img img").attr("src").replace(/img-ref2-big\.png$/, 'img-ref2.png'));
		} else { 
			$(".only_pc .ref-img").removeClass("scroll");
			$(".only_pc .ref-img img").attr("src",$(".only_pc .ref-img img").attr("src").replace(/img-ref2\.png$/, 'img-ref2-big.png'));
		}
		...
		var fadeStartDiv3 = divY3, fadeUntilDiv3 = divY3 + $(window).height(), fadeUntilDiv32 = divY3 + ($(window).height()/2),fadeStartDiv4 = divY4, fadeUntilDiv4 = divY4 + ($(window).height() / 2), fadeUntilDiv5 = divY4 + ($(window).height());
		var opacity6 = 0,opacity7 = 0;

$(function() {
    ...
    if ($(window).width() > 1300) {
        ...
        $(".only_mobile .scroll-area .fir").css("width", resizefirW2M);
        $(".only_mobile .scroll-area").css("width", firW2M);
    } else {
    ...
    function scrollEventM() {
        ...
        if (scrollEM >= 1 && scrollEM < 30) {
            ...
            $(".only_mobile .detail .ref-width").css({
                "text-align": "right",
                right: "-50px",
                bottom: "-50px"
            });
            ...
            var tranlateM = 'scale(0.7) translateY(' + scrollEM * 0.5 + 'px) translateX(0px)';
            $(".only_mobile .ref-img").css({
                transform: tranlateM,
            });
            $(".only_mobile .detail .ref-width").css({
        ...
        if (scrollEM >= 100) {
            ...
            $(".only_mobile .ref-img img").attr("src", $(".only_mobile .ref-img img").attr("src").replace(/img-oven-big\.png$/, 'img-oven.png'));
        } else {
            $(".only_mobile .ref-img").removeClass("scroll");
            $(".only_mobile .ref-img img").attr("src", $(".only_mobile .ref-img img").attr("src").replace(/img-oven\.png$/, 'img-oven-big.png'));
        }
